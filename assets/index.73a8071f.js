const o=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const t of i)if(t.type==="childList")for(const c of t.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function s(i){const t={};return i.integrity&&(t.integrity=i.integrity),i.referrerpolicy&&(t.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?t.credentials="include":i.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(i){if(i.ep)return;i.ep=!0;const t=s(i);fetch(i.href,t)}};o();function d(l,e){const s=l;s.focus(),s.setRangeText(e,s.selectionStart,s.selectionStart,"end")}class r{constructor(e){this.model=e,this.pressed=[]}handleEvent(e){switch(e.stopPropagation(),e.type){case"click":this.clickHandler();break;case"keydown":this.pressKey(e),this.changeLanguageDetector(e);break;case"keyup":this.removeTransition(e);break;case"mousedown":this.keydown(e);break;case"mouseup":r.keyup(e);break;default:console.log(e.target)}}get modelLanguage(){return this.model.language}get modelRegister(){return this.model.upperCase}clickHandler(){this.changeLanguage()}changeLanguage(){this.model.language==="en"?this.model.language="ru":this.model.language==="ru"&&(this.model.language="en"),this.model.notify(this.model)}changeLanguageDetector(e){this.pressed.push(e.key);const s="cornify";this.pressed.splice(-s.length-1,this.pressed.length-2),this.pressed.includes("Shift")&&this.pressed.includes("Alt")&&this.changeLanguage()}changeRegister(){this.model.upperCase=!this.model.upperCase,this.model.notify(this.model)}getUpperCase(){this.model.upperCase=!0,this.model.notify(this.model)}getLowerCase(){this.model.upperCase=!1,this.model.notify(this.model)}keydown(e){const s=e.target.closest(".key"),a=document.querySelector("#textarea");if(s&&s.classList.add("pressed","pressed--mouse"),s){let i;switch(console.log(s.dataset.key),console.log(this.model.chars[this.model.language][s.dataset.key]),s.dataset.key.includes("Key")&&(this.modelRegister?i=this.model.chars[this.model.language][s.dataset.key].toUpperCase():i=this.model.chars[this.model.language][s.dataset.key].toLowerCase()),s.dataset.key.includes("Digit")&&(i=s.dataset.key.replace("Digit","")),i&&(a.focus(),d(a,i)),s.dataset.key){case"Tab":d(a,"    ");break;case"CapsLock":this.changeRegister();break;case"Backquote":this.model.language==="en"?d(a,"`"):d(a,"\u0451");break;case"Minus":d(a,"-");break;case"Equal":d(a,"=");break;case"Enter":d(a,"\r");break;case"Space":d(a," ");break;case"Backslash":d(a,"\\");break;case"ArrowUp":d(a,"\u{1F815}");break;case"ArrowDown":d(a,"\u{1F817}");break;case"ArrowLeft":d(a,"\u{1F814}");break;case"ArrowRight":d(a,"\u{1F816}");break;case"BracketLeft":this.model.language==="en"?d(a,"["):d(a,"\u0445");break;case"BracketRight":this.model.language==="en"?d(a,"]"):d(a,"\u044A");break;case"Semicolon":this.model.language==="en"?d(a,";"):d(a,"\u0436");break;case"Quote":this.model.language==="en"?d(a,"'"):d(a,"\u044D");break;case"Comma":this.model.language==="en"?d(a,","):d(a,"\u0431");break;case"Period":this.model.language==="en"?d(a,"."):d(a,"\u044E");break;case"Slash":this.model.language==="en"?d(a,"/"):d(a,".");break}}}static keyup(){const e=document.querySelector(".pressed--mouse");e&&e.classList.remove("pressed","pressed--mouse")}pressKey(e){const s=document.querySelector(`.key[data-key="${e.code}"]`);s.classList.contains("prevent-default")&&e.preventDefault(),s.classList.add("pressed");const a=document.querySelector("#textarea");a.focus(),e.key==="CapsLock"&&this.changeRegister(),e.key==="Shift"&&this.getUpperCase(),e.key==="Tab"&&d(a,"    ")}removeTransition(e){document.querySelector(`.key[data-key="${e.code}"]`).classList.remove("pressed"),this.pressed=[],e.key==="Shift"&&this.getLowerCase()}}class y{constructor(){this.observers=[]}addObserver(e){this.observers.push(e)}removeObserver(e){const s=this.observers.findIndex(a=>e===a);s!==-1&&(this.observers=this.observers.slice(s,1))}notify(e){this.observers.length>0&&this.observers.forEach(s=>s.update(e))}}class v extends y{constructor(){super(),this.language="en",this.upperCase=!1,this.chars={en:{KeyQ:"q",KeyW:"w",KeyE:"e",KeyR:"r",KeyT:"t",KeyY:"y",KeyU:"u",KeyI:"i",KeyO:"o",KeyP:"p",KeyA:"a",KeyS:"s",KeyD:"d",KeyF:"f",KeyG:"g",KeyH:"h",KeyJ:"j",KeyK:"k",KeyL:"l",KeyZ:"z",KeyX:"x",KeyC:"c",KeyV:"v",KeyB:"b",KeyN:"n",KeyM:"m",Semicolon:":<br />;",Quote:`"<br />'`,Comma:"&lt;<br />,",Period:"><br />.",Slash:"?<br />/",Backquote:"~<br />'",BracketLeft:"{<br />[",BracketRight:"}<br />]",Backslash:"|<br />&#92;"},ru:{KeyQ:"\u0439",KeyW:"\u0446",KeyE:"\u0443",KeyR:"\u043A",KeyT:"\u0435",KeyY:"\u043D",KeyU:"\u0433",KeyI:"\u0448",KeyO:"\u0449",KeyP:"\u0437",KeyA:"\u0444",KeyS:"\u044B",KeyD:"\u0432",KeyF:"\u0430",KeyG:"\u043F",KeyH:"\u0440",KeyJ:"\u043E",KeyK:"\u043B",KeyL:"\u0434",KeyZ:"\u044F",KeyX:"\u0447",KeyC:"\u0441",KeyV:"\u043C",KeyB:"\u0438",KeyN:"\u0442",KeyM:"\u044C",Semicolon:"\u0436",Quote:"\u044D",Comma:"\u0431",Period:"\u044E",Slash:".",Backquote:"\u0451",BracketLeft:"\u0445",BracketRight:"\u044A",Backslash:"|<br />&#92;"}}}}class k{static update(){}}class n extends k{constructor(e){super(),this.controller=e,this.controller.model.addObserver(this),window.addEventListener("keydown",e),window.addEventListener("keyup",e),window.addEventListener("mousedown",e),window.addEventListener("mouseup",e)}update(e){const s=e.chars[this.controller.modelLanguage];for(const[a,i]of Object.entries(s)){const t=document.querySelector(`.key[data-key="${a}"]`);console.log(a),console.log(t),this.controller.modelRegister?t.querySelector(".keycap").innerHTML=i.toUpperCase():t.querySelector(".keycap").innerHTML=i}}render(){const e=document.querySelector("body"),s=`<form action="#" id="form">
      ...
      </div>`,a=document.createElement("div");a.id="app",a.innerHTML=s,e.insertAdjacentElement("afterbegin",a)}}function h(){const l=document.querySelector("#app"),e=`<div class="desription">
  <p>\u041A\u043B\u0430\u0432\u0438\u0430\u0442\u0443\u0440\u0430 \u0441\u043E\u0437\u0434\u0430\u043D\u0430 \u0432 \u043E\u043F\u0435\u0440\u0430\u0446\u0438\u043E\u043D\u043D\u043E\u0439 \u0441\u0438\u0441\u0442\u0435\u043C\u0435 Windows</p>
  <p>\u0414\u043B\u044F \u043F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u044F \u044F\u0437\u044B\u043A\u0430 \u043A\u043E\u043C\u0431\u0438\u043D\u0430\u0446\u0438\u044F: \u043B\u0435\u0432\u044Be Shift + Alt</p>
</div>`;l.insertAdjacentHTML("beforeend",e)}const p=new v,u=new r(p),g=new n(u);g.render();h();
