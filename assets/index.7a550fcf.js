const y=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))a(d);new MutationObserver(d=>{for(const t of d)if(t.type==="childList")for(const l of t.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(d){const t={};return d.integrity&&(t.integrity=d.integrity),d.referrerpolicy&&(t.referrerPolicy=d.referrerpolicy),d.crossorigin==="use-credentials"?t.credentials="include":d.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(d){if(d.ep)return;d.ep=!0;const t=s(d);fetch(d.href,t)}};y();function i(c,e){const s=c;s.focus(),s.setRangeText(e,s.selectionStart,s.selectionStart,"end")}function o(c,e){const s=c;s.focus();try{e==="backspace"?s.setRangeText("",s.selectionStart-1,s.selectionStart,"end"):e==="delete"&&s.setRangeText("",s.selectionStart,s.selectionStart+1,"end")}catch{}}class r{constructor(e){this.model=e,this.pressed=[]}handleEvent(e){switch(e.stopPropagation(),e.type){case"click":this.clickHandler();break;case"keydown":this.pressKey(e),this.changeLanguageDetector(e);break;case"keyup":this.removeTransition(e);break;case"mousedown":this.keydown(e);break;case"mouseup":r.keyup(e);break}}get modelLanguage(){return this.model.language}get modelRegister(){return this.model.upperCase}clickHandler(){this.changeLanguage()}changeLanguage(){this.model.language==="en"?this.model.language="ru":this.model.language==="ru"&&(this.model.language="en"),this.model.notify(this.model)}changeLanguageDetector(e){this.pressed.push(e.key);const s="cornify";this.pressed.splice(-s.length-1,this.pressed.length-2),this.pressed.includes("Shift")&&this.pressed.includes("Alt")&&this.changeLanguage()}changeRegister(){this.model.upperCase=!this.model.upperCase,this.model.notify(this.model)}getUpperCase(){this.model.upperCase=!0,this.model.notify(this.model)}getLowerCase(){this.model.upperCase=!1,this.model.notify(this.model)}keydown(e){const s=e.target.closest(".key"),a=document.querySelector("#textarea");if(s&&s.classList.add("pressed","pressed--mouse"),s){let d;switch(s.dataset.key.includes("Key")&&(this.modelRegister?d=this.model.chars[this.model.language][s.dataset.key].toUpperCase():d=this.model.chars[this.model.language][s.dataset.key].toLowerCase()),s.dataset.key.includes("Digit")&&(d=s.dataset.key.replace("Digit","")),d&&(a.focus(),i(a,d)),s.dataset.key){case"Tab":i(a,"    ");break;case"CapsLock":this.changeRegister();break;case"Backquote":this.model.language==="en"?i(a,"`"):i(a,"\u0451");break;case"Minus":i(a,"-");break;case"Equal":i(a,"=");break;case"Enter":i(a,"\r");break;case"Space":i(a," ");break;case"Backslash":i(a,"\\");break;case"ArrowUp":i(a,"\u{1F815}");break;case"ArrowDown":i(a,"\u{1F817}");break;case"ArrowLeft":i(a,"\u{1F814}");break;case"ArrowRight":i(a,"\u{1F816}");break;case"Backspace":o(a,"backspace");break;case"Delete":o(a,"delete");break;case"BracketLeft":this.model.language==="en"?i(a,"["):i(a,"\u0445");break;case"BracketRight":this.model.language==="en"?i(a,"]"):i(a,"\u044A");break;case"Semicolon":this.model.language==="en"?i(a,";"):i(a,"\u0436");break;case"Quote":this.model.language==="en"?i(a,"'"):i(a,"\u044D");break;case"Comma":this.model.language==="en"?i(a,","):i(a,"\u0431");break;case"Period":this.model.language==="en"?i(a,"."):i(a,"\u044E");break;case"Slash":this.model.language==="en"?i(a,"/"):i(a,".");break}}}static keyup(){const e=document.querySelector(".pressed--mouse");e&&e.classList.remove("pressed","pressed--mouse")}pressKey(e){const s=document.querySelector(`.key[data-key="${e.code}"]`);s.classList.contains("prevent-default")&&e.preventDefault(),s.classList.add("pressed");const a=document.querySelector("#textarea");a.focus(),e.key==="CapsLock"&&this.changeRegister(),e.key==="Shift"&&this.getUpperCase(),e.key==="Tab"&&i(a,"    ")}removeTransition(e){document.querySelector(`.key[data-key="${e.code}"]`).classList.remove("pressed"),this.pressed=[],e.key==="Shift"&&this.getLowerCase()}}class v{constructor(){this.observers=[]}addObserver(e){this.observers.push(e)}removeObserver(e){const s=this.observers.findIndex(a=>e===a);s!==-1&&(this.observers=this.observers.slice(s,1))}notify(e){this.observers.length>0&&this.observers.forEach(s=>s.update(e))}}class k extends v{constructor(){super(),this.language="en",this.upperCase=!1,this.chars={en:{KeyQ:"q",KeyW:"w",KeyE:"e",KeyR:"r",KeyT:"t",KeyY:"y",KeyU:"u",KeyI:"i",KeyO:"o",KeyP:"p",KeyA:"a",KeyS:"s",KeyD:"d",KeyF:"f",KeyG:"g",KeyH:"h",KeyJ:"j",KeyK:"k",KeyL:"l",KeyZ:"z",KeyX:"x",KeyC:"c",KeyV:"v",KeyB:"b",KeyN:"n",KeyM:"m",Semicolon:":<br />;",Quote:`"<br />'`,Comma:"&lt;<br />,",Period:"><br />.",Slash:"?<br />/",Backquote:"~<br />'",BracketLeft:"{<br />[",BracketRight:"}<br />]",Backslash:"|<br />&#92;"},ru:{KeyQ:"\u0439",KeyW:"\u0446",KeyE:"\u0443",KeyR:"\u043A",KeyT:"\u0435",KeyY:"\u043D",KeyU:"\u0433",KeyI:"\u0448",KeyO:"\u0449",KeyP:"\u0437",KeyA:"\u0444",KeyS:"\u044B",KeyD:"\u0432",KeyF:"\u0430",KeyG:"\u043F",KeyH:"\u0440",KeyJ:"\u043E",KeyK:"\u043B",KeyL:"\u0434",KeyZ:"\u044F",KeyX:"\u0447",KeyC:"\u0441",KeyV:"\u043C",KeyB:"\u0438",KeyN:"\u0442",KeyM:"\u044C",Semicolon:"\u0436",Quote:"\u044D",Comma:"\u0431",Period:"\u044E",Slash:".",Backquote:"\u0451",BracketLeft:"\u0445",BracketRight:"\u044A",Backslash:"|<br />&#92;"}}}}class n{static update(){}}class h extends n{constructor(e){super(),this.controller=e,this.controller.model.addObserver(this),window.addEventListener("keydown",e),window.addEventListener("keyup",e),window.addEventListener("mousedown",e),window.addEventListener("mouseup",e)}update(e){const s=e.chars[this.controller.modelLanguage];for(const[a,d]of Object.entries(s)){const t=document.querySelector(`.key[data-key="${a}"]`);this.controller.modelRegister?t.querySelector(".keycap").innerHTML=d.toUpperCase():t.querySelector(".keycap").innerHTML=d}}render(){const e=document.querySelector("body"),s=`<form action="#" id="form">
...
</div>`;c.insertAdjacentHTML("beforeend",e)}const u=new k,g=new r(u),m=new h(g);m.render();p();
